...
- Pro browser runs: responses can take 20m–1h+; never click "Answer now"; keep at least 1–2 Pro live tests (reattach must stay Pro); move other tests to faster models where safe.
...
- Browser “Pro thinking” gate: never click/auto-click ChatGPT’s “Answer now” button. Treat it as a placeholder and wait 20m–1h+ for the real assistant response (auto-clicking skips long thinking and changes behavior).
